document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función para cargar y renderizar las reservas
    function cargarReservasEnAdmin() {
        ...
        if (reservas.length === 0) {
            tablaReservasBody.innerHTML = '<tr><td colspan="7" class="text-center">No hay reservas registradas.</td></tr>';
            return;
        }
